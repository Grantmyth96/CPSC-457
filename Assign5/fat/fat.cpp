...
//
// Author of check_consistency method: Juan Luis de Reiset Jimenez-Carbo 
// Student ID: 30050167
// Tutorial: T01
// Version: 1
//
// Compile with g++ fat.cpp -o fat
// Run with ./fat < "filename.txt" 
//******************************************************************************
#include <stdio.h>
#include <string>
#include <vector>
...
{
	vector<int> blocks;
	//Check how many blocks each file needs and store in the arrat "blocks"
	for (int i = 0; i < files.size(); i++)
	{
		int blocksNeeded = 0;
		int counter = files[i].size;	//counter used to safe the size of the file found at position i
		...
		blocks.push_back(blocksNeeded);	//push the values of block needed to the blocks array
	}
